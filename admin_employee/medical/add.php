<form id="addform" action="" method="post" enctype="multipart/form-data">
  ...
  <input type="hidden" id="hfmed_id" name="hfmed_id" />
      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="40%">
            ...
            > <a href="index.php?module=health_care" style="color: black;text-decoration: none;"> Medical coordination</a>
            > <a href="index.php?module=health_care" style="color:#fb9678;text-decoration: none;"> Add Medical coordination</a>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="txtmed_name" name="txtmed_name" class="form-control" placeholder="Name Ar" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtmed_name_en" name="txtmed_name_en" class="form-control" placeholder="Name En" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtmed_mobile1" name="txtmed_mobile1" class="form-control" placeholder="Mobile 1" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="txtmed_mobile2" name="txtmed_mobile2" class="form-control" placeholder="Mobile 2" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtmed_mail" name="txtmed_mail" class="form-control" placeholder="Email" required />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o"></i>
                  <input type="text" id="txtmed_website" name="txtmed_website" class="form-control" placeholder="Website" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtmed_loc" name="txtmed_loc" class="form-control" placeholder="Location" />
                </div>
              </div><!-- end test -->

  <!-- test-->
              <div class="col-md-6 mb-1 mt-1">
                <p style="display: block !important;margin-bottom: 0px;">Countries </p>
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtmed_country" name="txtmed_country" class="form-control" placeholder="Country" />
                </div>
              </div><!-- end test -->
