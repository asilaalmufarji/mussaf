    ...
    <table width="100%" border="0">
      <tr>
        ...
        <td width="40%">
          ...
          > <a href="index.php?module=medical" style="color:#fb9678;text-decoration: none;"> Medical coordination</a>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-12 card">
        <div style="padding: 10px;">
          <table id="medicalList" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th></th>
                <th>#</th>
