<form id="addform" action="" method="post" enctype="multipart/form-data">
  ...
  <input type="hidden" id="hfstu_id" name="hfstu_id" />
      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="40%">
            ...
            > <a href="index.php?module=study_outside" style="color: black;text-decoration: none;"> Study</a>
            > <a href="index.php?module=study_outside" style="color:#fb9678;text-decoration: none;"> Add Study outside</a>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="txtstu_name" name="txtstu_name" class="form-control" placeholder="Name Ar" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtstu_name_en" name="txtstu_name_en" class="form-control" placeholder="Name En" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtstu_mobile1" name="txtstu_mobile1" class="form-control" placeholder="Mobile 1" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="txtstu_mobile2" name="txtstu_mobile2" class="form-control" placeholder="Mobile 2" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtstu_mail" name="txtstu_mail" class="form-control" placeholder="Email" required />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o"></i>
                  <input type="text" id="txtstu_website" name="txtstu_website" class="form-control" placeholder="Website" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtstu_loc" name="txtstu_loc" class="form-control" placeholder="Location" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                    <select id="cmbtyp_study_id" name="cmbtyp_study_id">
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                    <select id="cmbtyp_school_id" name="cmbtyp_school_id">
                      <option value="">Select Type</option>
                    </select>  
                </div>
              </div><!-- end test -->
