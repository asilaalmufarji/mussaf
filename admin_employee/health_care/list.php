    ...
    <table width="100%" border="0">
      <tr>
        ...
        <td width="40%">
          ...
          > <a href="index.php?module=health_care" style="color:#fb9678;text-decoration: none;"> Health care service</a>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-12 card">
        <div style="padding: 10px;">
          <table id="health_careList" class="table table-bordered table-striped">
            <thead>
              <tr>
                <th></th>
                <th>#</th>
