<form id="addform" action="" method="post" enctype="multipart/form-data">
  ...
  <input type="hidden" id="hfcus_id" name="hfcus_id" />
      ...
      <table width="100%" border="0">
        <tr>
          ...
          <td width="40%">
            ...
            > <a href="index.php?module=customer" style="color: black;text-decoration: none;"> Ticket</a>
            > <a href="index.php?module=customer" style="color:#fb9678;text-decoration: none;"> Add Ticket</a>
            ...
            <div class="row">
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="txtcus_name" name="txtcus_name" class="form-control" placeholder="Name Ar" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtcus_name_en" name="txtcus_name_en" class="form-control" placeholder="Name En" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtcus_mobile1" name="txtcus_mobile1" class="form-control" placeholder="Mobile 1" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  ...
                  <input type="text" id="txtcus_mobile2" name="txtcus_mobile2" class="form-control" placeholder="Mobile 2" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtcus_mail" name="txtcus_mail" class="form-control" placeholder="Email" required />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o"></i>
                  <input type="text" id="txtcus_website" name="txtcus_website" class="form-control" placeholder="Website" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                  <input type="text" id="txtcus_loc" name="txtcus_loc" class="form-control" placeholder="Location" />
                </div>
              </div><!-- end test -->
              ...
              <div class="col-md-6 mb-1 mt-1">
                ...
                <!-- test-->
              <div class="col-md-6 mb-1 mt-1">
                <p style="display: block !important;margin-bottom: 0px;">Service</p>
                <div class="input-group">
                  <i class="input-group-text fa fa-file-text-o" style="background-color: #FFCACA;color:white;border-color: #FFCACA;"></i>
                    <select id="cmbser_id" name="cmbser_id">
